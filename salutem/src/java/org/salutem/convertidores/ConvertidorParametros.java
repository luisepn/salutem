...
public class ConvertidorParametros implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try {
            ...
            codigo = bean.traerParametro(id);
        } catch (ExcepcionDeConsulta ex) {
            Mensajes.fatal(ex.getMessage());
            Logger.getLogger(ConvertidorParametros.class.getName()).log(Level.SEVERE, null, ex);
        }
        return codigo;
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        Parametros codigo = (Parametros) value;
        if (codigo.getId() == null) {
            return "0";
        }
        return ((Parametros) value).getId().toString();
    }
}
